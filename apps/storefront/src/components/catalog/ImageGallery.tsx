    ...
    <div className="flex flex-col gap-4">
      <div className="aspect-[4/5] bg-surface-container-low rounded-xl overflow-hidden border border-outline-variant relative group">
        <Image
          ...
          priority
        />
        <button className="absolute top-4 right-4 bg-surface/80 backdrop-blur-md p-3 rounded-full border border-outline-variant text-on-surface hover:bg-primary hover:text-on-primary transition-all duration-300">
